...
class Player():
    def __init__(self, x, y):
        ...
        self.sprite = pygame.image.load("./arcadev-ufpi-victor/aula 6/images/steve2.png")
...
class Grass(Tile):
    def __init__(self, x, y):
        super().__init__(x,y)
        self.sprite = pygame.image.load("./arcadev-ufpi-victor/aula 6/images/grass.png")
        
class Water(Tile):
    def __init__(self, x, y):
        super().__init__(x,y)
        self.sprite = pygame.image.load("./arcadev-ufpi-victor/aula 6/images/water.png")
